...
const char *sketchName = "ctd_wifibee_ext_batt_voltage.ino";
...
float moderate_bat_voltage = 11.2; // -rm
...
Variable *extvoltV = new ExternalVoltage_Volt(&extvolt, "8952f24c-ea91-47d8-a555-ea54f4f7b876");
...
void setup()
{
    ...
    //#endif // not using softwareserial - rm
    ...
    if (getBatteryVoltage() > minimum_bat_voltage || !dataLogger.isRTCSane())
    {
        modem.modemPowerUp();
        modem.wake();
        modem.setup();
