/*
 *DigiXBeeCellularTransparent_Rachel.cpp
...
#include "DigiXBeeCellularTransparent_Rachel.h"
#include "modems/LoggerModemMacros.h"

// Constructor/Destructor
DigiXBeeCellularTransparent_Rachel::DigiXBeeCellularTransparent_Rachel(Stream* modemStream,
...
// Destructor
DigiXBeeCellularTransparent_Rachel::~DigiXBeeCellularTransparent_Rachel(){}


MS_MODEM_DID_AT_RESPOND(DigiXBeeCellularTransparent_Rachel);
MS_MODEM_IS_INTERNET_AVAILABLE(DigiXBeeCellularTransparent_Rachel);
MS_MODEM_VERIFY_MEASUREMENT_COMPLETE(DigiXBeeCellularTransparent_Rachel);
MS_MODEM_GET_MODEM_SIGNAL_QUALITY(DigiXBeeCellularTransparent_Rachel);
MS_MODEM_GET_MODEM_BATTERY_NA(DigiXBeeCellularTransparent_Rachel);
MS_MODEM_GET_MODEM_TEMPERATURE_AVAILABLE(DigiXBeeCellularTransparent_Rachel);
MS_MODEM_CONNECT_INTERNET(DigiXBeeCellularTransparent_Rachel);


bool DigiXBeeCellularTransparent_Rachel::extraModemSetup(void)
{
    bool success = true;
    ...
    if (gsmModem.commandMode())
    {
        ...
        // Cellular carrier profile - CHANGED TO AUTO-DETECT -rm
...
/*uint32_t DigiXBeeCellularTransparent_Rachel::getNISTTime(void)
{
...
bool DigiXBeeCellularTransparent_Rachel::addSingleMeasurementResult(void)
{
    bool success = true;
