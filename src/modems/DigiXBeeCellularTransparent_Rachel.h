/*
 *DigiXBeeCellularTransparent_Rachel.h
...
#define MS_DEBUGGING_STD "DigiXBeeCellularTransparent_Rachel"
#endif
...
class DigiXBeeCellularTransparent_Rachel : public DigiXBee
{

public:
    // Constructor/Destructor
    DigiXBeeCellularTransparent_Rachel(Stream* modemStream,
                                int8_t powerPin, int8_t statusPin, bool useCTSStatus,
                                int8_t modemResetPin, int8_t modemSleepRqPin,
                                const char *apn,
                                uint8_t measurementsToAverage = 1);
    ~DigiXBeeCellularTransparent_Rachel();
