...
byte y4000ModbusAddress = 0x01;  // The modbus address of the Y504
...
const uint8_t y4000NumberReadings = 1;  // The manufacturer recommends averaging 10 readings, but we take 5 to minimize power consumption
