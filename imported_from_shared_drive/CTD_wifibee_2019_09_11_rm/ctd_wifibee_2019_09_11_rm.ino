...
/*************************************************************************
How I set up the libraries for this script:

To get the correct libraries for this script, I downloaded the libraries from
the enviroDIY github page labeled 'libraries.' There are instructions for downloading
these in the 'Readme' file in that repository.

We had lots of headaches with having the wrong libraries downloaded, so I have
included the exact libraries I used for this script in the folder in the
shared drive. It should be library version .10 of the EnviroDIY modularsensors
library.
...
// ==========================================================================
 #ifndef SDI12_EXTERNAL_PCINT // only needed for the decagon I think
 #define SDI12_EXTERNAL_PCINT // sometimes causes problems -rm
 #endif
 ...
 #endif
 #ifndef MS_ESPRESSIFESP8266_DEBUG_DEEP // added this, comment out to remove debugging 
 #define MS_ESPRESSIFESP8266_DEBUG_DEEP // requires streamdebugger library -rm
 #endif
...
const char *sketchName = "ctd_wifibee_2019_09_11.ino";
// Logger ID, also becomes the prefix for the name of the data file on SD card
const char *LoggerID = "IOWtest";
// How frequently (in minutes) to log data
const uint8_t loggingInterval = 5; // set to 5 for testing -rm
// Your logger's timezone.
const int8_t timeZone = 12;  // Changed to Auckland -rm
...
// The baud rate was changed when we updated the firmware on the wifi bees -rm
...
//=======================================================
// Onboard temperature sensor for the mayfly -rm
//===============================================
...
//commented this all out because it wasn't working -rm
...
// set uuid's for my 'test' site on the Waikato campus -rm
...
// set uuid's for my test site on the Waikato campus
