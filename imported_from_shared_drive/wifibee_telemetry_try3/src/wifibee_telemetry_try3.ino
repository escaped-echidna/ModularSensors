...
Modified my Rachel Murray on 24/07/2019
...
const char *sketchName = "wifibee_telemetry_try3.ino"; // changed this - rm
...
const int8_t timeZone = 12;  // set to time zone 5 to test - rm
...
//const int8_t neoSSerial1Tx = 12;     //  -1pj  data out pin
